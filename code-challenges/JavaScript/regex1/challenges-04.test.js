...
const matchMonth = (input) => {
  ...
  if (regex2.test(input) === true) {
    correct = true;
  }
  if (regex3.test(input) === true) {
    correct = true;
  }
  if (regex4.test(input) === true) {
    correct = true;
  }
